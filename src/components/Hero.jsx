  ...
  <section className="dark:bg-gray-800">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
          ...
          <div className="flex flex-row space-y-0 justify-center">
            <Link to="/planning" className="btn btn-accent inline-flex justify-center items-center py-3 px-5 mr-3 text-base font-medium text-center text-white rounded-lg">
                <span>Planning</span>
                <MdViewTimeline size={20}/>
            </Link>
            <button onClick={handleShow} className="btn btn-secondary inline-flex justify-center items-center ml-3 py-3 px-5 text-base font-medium text-center text-white rounded-lg">
                <span>Match</span>
                <LuSwords size={20}/>
            </button>
            <button to="/" className="btn btn-primary inline-flex justify-center items-center ml-3 py-3 px-5 text-base font-medium text-center text-white rounded-lg">
                <span>Tournois</span>
