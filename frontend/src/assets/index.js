...
export { default as Superliga } from './Superliga.webp';
export { default as PrimeLeague } from './prime-league.png';
export { default as TCL } from './TCL.png';
export { default as Nashor } from './Nashor.png';
export { default as Champ } from './Champion.webp';

export { default as Rugby } from './rugby-logo.png';
export { default as BgRugby } from './Bg-Rugby.jpg';
...
export { default as ProD2 } from './ProD2.png';
