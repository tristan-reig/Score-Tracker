...
import Vct from "../assets/vct_emea.png"
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 p-5 gap-10">
          ...
          <Link to="/rugby/prod2" className="mx-auto">
          ...
          <Link to="/valorant/vct-emea?id=7178" className='mx-auto'>
            <img className="h-72 w-72 2xl:h-96 2xl:w-96 p-5 rounded-lg cursor-pointer bg-gradient-to-r from-red-400 to-red-700 transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-105 duration-150" src={Vct} alt=""/>
          </Link>
      </div>
    </>
  )
